...
var getSquare = function getSquare() {
  var lengthVal = document.cl_form.lengthAmount.value;
  var heightVal = document.cl_form.heightAmount.value;
  if (lengthVal > 0 && heightVal > 0) {
    var res = (lengthVal * heightVal / 1000000).toFixed(2);
...
var getSumm = function getSumm() {
  var stvorkiVal = document.cl_form.stvorAmount.value;
  var netsVal = document.cl_form.netsAmount.value;

  if (stvorkiVal > 0 && netsVal > 0) {
    var summ = 30000 + 15000 + (2200 + 1500 + 780) * getSquare() + 11000 * stvorkiVal + 2500 * netsVal;
 ...
 */
var cl_form = document.querySelector("form");
var inputs = cl_form.querySelectorAll("input");
...
var _foundation6 = __webpack_require__(21);
...
_foundation.Foundation.plugin(_foundation3.ResponsiveMenu, "ResponsiveMenu");
...
_foundation.Foundation.plugin(_foundation6.Slider, "Slider");
